...
const Navbar = () => {
    ...
    return (
        <nav className="md:flex justify-between items-center bg-white sticky top-0 z-20">
            ...
            <ul className={(showNav ? "left-0" : "-left-full") + " md:static fixed bottom-0 top-12 md:flex md:space-x-7 items-center md:bg-transparent bg-gray-500 bg-opacity-90 md:w-auto w-10/12 md:text-gray-500 text-white md:space-y-0 space-y-5 p-2 transition-left"}>
                <li>
