...
const Wallet = () => {
  return (
    <>
      <h1 className="mb-8 text-3xl font-bold text-center md:text-4 lg:text-4xl">Crypto Wallets</h1>
      <p className="mb-6 text-center lg:text-xl">BlockVault provides support for some commonly use crypto wallets for authentication and login</p>      
      <section className="relative">
        <div className="grid grid-cols-2 gap-14">
          <div className="border-2 border-#DFDFDF rounded-xl p-12 h-96 text-left relative hover:-translate-y-2 duration-300 hover:shadow bg-nord5">
            ...
            <img src={metamask} className="inline-block w-10 h-10" alt="MetaMask"/>
            <p>
          ...
          <div className="relative p-12 text-left duration-300 border-2 rounded-xl h-96 hover:-translate-y-2 hover:shadow bg-nord5">
            ...
            <img src={phantom} className="inline-block w-10 h-10" alt="Phantom"/>
            <p>
