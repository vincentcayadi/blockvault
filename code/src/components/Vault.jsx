          ...
          <div className="flex flex-col items-center flex-1 pl-8 lg:items-start">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Link
                exact
                to="/dashboard"
                className="bg-nord1 text-white py-4 px-10 rounded-full text-8 shadow-xl hover:bg-transparent border-2 hover:border-nord1 hover:text-nord1 hover:scale-110% duration-200 delay-100 dark:bg-nord6 dark:text-nord0"
              >
                Enter App
              </Link>
            </div>
